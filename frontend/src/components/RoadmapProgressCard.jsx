...
const RoadmapProgressCard = ({ progress, estimatedDuration, currentWeek }) => (
  <SectionCard>
    <div className="flex flex-col gap-1 sm:flex-row sm:items-end sm:justify-between sm:gap-4"><div><p className="text-sm font-medium text-slate-500">Overall progress</p><p className="mt-1 text-3xl font-bold text-indigo-600 dark:text-indigo-400">{progress}%</p></div><p className="text-sm text-slate-500">{estimatedDuration}</p></div>
