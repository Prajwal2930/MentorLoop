...
const DashboardPage = () => {
  ...
  if (!dashboard) return error ? <p className="rounded-xl bg-red-50 p-4 text-red-700 dark:bg-red-500/10 dark:text-red-300">{error}</p> : <LoadingSpinner label="Preparing your workspace..." />;
